...
```
                    ...
                    │                    FORWARDING PATHS                                      │
                    │     ┌─────────────────────────────────────────────────┐                   │
                    │     │  EX/MEM Forwarding (1 instr ago)               │                   │
                    │     │  ┌─────────────────────────────────────────────────────────────┐    │
                    │     │  │  MEM/WB Forwarding (2 instrs ago)                           │    │
                    │     │  │                                                             │    │
                    ▼     ▼  ▼                                                             │    │
┌────────┐   ┌──────────┐   ┌──────────┐   ┌──────────────┐   ┌─────────────┐   ┌────────────┐
│        │   │  IF/ID   │   │  ID/EX   │   │   EX/MEM     │   │  MEM/WB     │   │            │
│  PC    │──▶│  Pipeline│──▶│  Pipeline│──▶│   Pipeline   │──▶│  Pipeline   │──▶│  REG FILE  │
│  REG   │   │  Reg     │   │  Reg     │   │   Reg        │   │  Reg        │   │  (Write)   │
│        │   │          │   │          │   │              │   │             │   │            │
└───┬────┘   └──────────┘   └──────────┘   └──────────────┘   └─────────────┘   └────────────┘
    │             │              │                │                  │
    │        ┌────┴────┐   ┌────┴─────┐    ┌─────┴──────┐    ┌─────┴─────┐
    │        │ INST    │   │  ALU     │    │  DATA     │    │ WB MUX   │
    │        │ MEM     │   │  BRANCH  │    │  MEM      │    │ ALU/MEM/ │
    │        │ IMM_GEN │   │  UNIT    │    │ (R/W)     │    │ PC+4     │
    │        │ CONTROL │   │          │    │           │    │          │
    │        │ REG READ│   │          │    │           │    │          │
    │        └─────────┘   └──────────┘    └───────────┘    └──────────┘
    │                           │
...
<p align="center">
  <img src="Pipeline/docs/gtkwave_waveform.png" alt="GTKWave Simulation Waveform — Pipeline State Over Time" width="100%"/>
  <br/>
...
<p align="center">
  <img src="Pipeline/docs/vivado_schematic.png" alt="Vivado Post-Synthesis Schematic — 556 Cells, 1393 Nets" width="100%"/>
  <br/>
...
<p align="center">
  <img src="Pipeline/docs/vivado_utilization_report.png" alt="Vivado FPGA Resource Utilization Report" width="85%"/>
  <br/>
...
<p align="center">
  <img src="Pipeline/docs/vivado_timing_report.png" alt="Vivado Timing Analysis Summary" width="70%"/>
  <br/>
...
<p align="center">
  <img src="Pipeline/docs/vivado_power_report.png" alt="Vivado Power Analysis — 0.145W Total On-Chip Power" width="85%"/>
  <br/>
